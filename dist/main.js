    ...
    const updateTodayTasks = () => {
        ...
        state.defaultProjects[0].tasks.forEach((task) => {
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(currentDate) === (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.createDueDate(task.dueDate))) {
                if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currentDate) === (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.createDueDate(task.dueDate))) {
                    if((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(currentDate) === (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.createDueDate(task.dueDate))) {
        ...
        state.defaultProjects[0].tasks.forEach((task) => {
            if((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(pastDate) === (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.createDueDate(task.dueDate))) {
                if((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(pastDate) === (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.createDueDate(task.dueDate))) {
                    if(((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(pastDate) < (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.createDueDate(task.dueDate))) && ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.createDueDate(task.dueDate)) < (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(futureDate))) {
    ...
    const loadCreatedProject = () => {
        ...
        for(let i = 0; i < localStorage.length; i++) {
            ...
            for(let j = 0; j < objArray.length; j++) {
                ...
                const newTask = (0,_task__WEBPACK_IMPORTED_MODULE_1__.task)(title, details, priority, dueDate, projectName, id);
...
const project = (name) => {
    ...
    // Sort tasks
    const sortTasks = () => {
        state.tasks.sort((a, b) => (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(a.createDueDate(a.dueDate), b.createDueDate(b.dueDate)));
    }
...
/* harmony import */ var _scripts_directory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/directory */ "./src/scripts/directory.js");
